  ...
  return (
    <DashboardLayout title="Dasbor Pengecer" entityLabel="Pengecer">
      ...
      <form onSubmit={handleSubmit} className="space-y-6 mt-6">
        <Card><CardHeader><CardTitle>Batch ID dari RMU/Distributor/Lembaga Logistik Pemerintah</CardTitle></CardHeader><CardContent><div className="space-y-2"><Label>ID Batch (RMU, Distributor, atau Lembaga Logistik Pemerintah)</Label><Input placeholder="cth. RMU_... / DISTRIBUTOR_... / BULOG_..." value={prevBatchId} onChange={e => setPrevBatchId(e.target.value)} required /></div></CardContent></Card>
